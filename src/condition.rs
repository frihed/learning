...
use std::str;
use crate::parser::{binary_logical_operator,binary_comparison_operator, unary_negation_operator};
use crate::parser::{ConditionBase,ConditionTree, ConditionExpression};
...
fn fold_cond_exprs(initial: ConditionExpression,
                remainder: Vec<(&str, ConditionExpression)>) -> ConditionExpression{
